...
export const cars: Car[] = [
  // ── Kia Niro EV ──────────────────────────────────────────────────────
  {
    id: 'niro-ev-2023-20k', rearLegroomIn: 36.9, make: 'Kia', model: 'Niro EV', trim: 'Wind', trimTier: 1,
  ...
  {
    id: 'prius-2023-30k', rearLegroomIn: 34.8, make: 'Toyota', model: 'Prius', trim: 'LE', trimTier: 1,
  ...
  {
    id: 'prius-2021-45k', rearLegroomIn: 33.4, make: 'Toyota', model: 'Prius', trim: 'LE', trimTier: 1,
  ...
  {
    id: 'prius-2019-62k', rearLegroomIn: 33.4, make: 'Toyota', model: 'Prius', trim: 'LE', trimTier: 1,
  ...
  {
    id: 'prius-2016-95k', rearLegroomIn: 33.4, make: 'Toyota', model: 'Prius', trim: 'Two', trimTier: 1,
  ...
  {
    id: 'prius-2023-15k', rearLegroomIn: 34.8, make: 'Toyota', model: 'Prius', trim: 'XLE', trimTier: 2,
  ...
  // ── Honda Fit ────────────────────────────────────────────────────────
  {
    id: 'fit-2019-48k', rearLegroomIn: 39.3, make: 'Honda', model: 'Fit', trim: 'LX', trimTier: 1,
  ...
  {
    id: 'fit-2019-70k', rearLegroomIn: 39.3, make: 'Honda', model: 'Fit', trim: 'Sport', trimTier: 2,
  ...
  {
    id: 'fit-2020-39k', rearLegroomIn: 39.3, make: 'Honda', model: 'Fit', trim: 'LX', trimTier: 1,
  ...
  {
    id: 'fit-2020-55k', rearLegroomIn: 39.3, make: 'Honda', model: 'Fit', trim: 'EX', trimTier: 2,
  ...
  // ── Tesla Model Y ────────────────────────────────────────────────────
  {
    id: 'modely-2021-50k', rearLegroomIn: 40.5, make: 'Tesla', model: 'Model Y', trim: 'Long Range AWD', trimTier: 3,
  ...
  {
    id: 'modely-2022-38k', rearLegroomIn: 40.5, make: 'Tesla', model: 'Model Y', trim: 'Long Range AWD', trimTier: 3,
  ...
  {
    id: 'modely-2023-25k', rearLegroomIn: 40.5, make: 'Tesla', model: 'Model Y', trim: 'RWD', trimTier: 1,
  ...
  {
    id: 'modely-2026-new', rearLegroomIn: 40.5, make: 'Tesla', model: 'Model Y', trim: 'RWD', trimTier: 1,
  ...
  {
    id: 'modely-2024-15k', rearLegroomIn: 40.5, make: 'Tesla', model: 'Model Y', trim: 'Long Range AWD', trimTier: 3,
  ...
  {
    id: 'crosstrek-phev-2019-72k', rearLegroomIn: 36.5, make: 'Subaru', model: 'Crosstrek Hybrid', trim: 'PHEV', trimTier: 1,
  ...
  {
    id: 'crosstrek-phev-2021-48k', rearLegroomIn: 36.5, make: 'Subaru', model: 'Crosstrek Hybrid', trim: 'PHEV', trimTier: 1,
  ...
  {
    id: 'crosstrek-phev-2023-28k', rearLegroomIn: 36.5, make: 'Subaru', model: 'Crosstrek Hybrid', trim: 'PHEV', trimTier: 1,
  ...
  {
    id: 'forester-hybrid-2026-new', rearLegroomIn: 39.4, make: 'Subaru', model: 'Forester Hybrid', trim: 'Premium', trimTier: 2,
    year: 2026, condition: 'new', mileage: 0, powertrain: 'hybrid',
  ...
  {
    id: 'crosstrek-hybrid-2026-new', rearLegroomIn: 36.5, make: 'Subaru', model: 'Crosstrek Hybrid', trim: 'Sport', trimTier: 1,
    year: 2026, condition: 'new', mileage: 0, powertrain: 'hybrid',
  ...
  {
    id: 'solterra-2023-22k', rearLegroomIn: 35.3, make: 'Subaru', model: 'Solterra', trim: 'Premium AWD', trimTier: 1,
  ...
  {
    id: 'crosstrek-2018-82k', rearLegroomIn: 36.5, make: 'Subaru', model: 'Crosstrek', trim: 'Premium', trimTier: 2,
  ...
  {
    id: 'crosstrek-2020-58k', rearLegroomIn: 36.5, make: 'Subaru', model: 'Crosstrek', trim: 'Premium', trimTier: 2,
  ...
  {
    id: 'crosstrek-2022-38k', rearLegroomIn: 36.5, make: 'Subaru', model: 'Crosstrek', trim: 'Premium', trimTier: 2,
  ...
  {
    id: 'crosstrek-2024-18k', rearLegroomIn: 36.5, make: 'Subaru', model: 'Crosstrek', trim: 'Premium', trimTier: 2,
  ...
  {
    id: 'forester-2018-88k', rearLegroomIn: 38, make: 'Subaru', model: 'Forester', trim: 'Premium', trimTier: 2,
  ...
  {
    id: 'forester-2020-60k', rearLegroomIn: 39.4, make: 'Subaru', model: 'Forester', trim: 'Premium', trimTier: 2,
  ...
  {
    id: 'forester-2022-40k', rearLegroomIn: 39.4, make: 'Subaru', model: 'Forester', trim: 'Premium', trimTier: 2,
  ...
  {
    id: 'forester-2024-20k', rearLegroomIn: 39.4, make: 'Subaru', model: 'Forester', trim: 'Premium', trimTier: 2,
  ...
  // ── Honda CR-V (gas) ─────────────────────────────────────────────────
  {
    id: 'crv-2018-78k', rearLegroomIn: 40.4, make: 'Honda', model: 'CR-V', trim: 'EX', trimTier: 1,
  ...
  {
    id: 'crv-2019-60k', rearLegroomIn: 40.4, make: 'Honda', model: 'CR-V', trim: 'EX-L', trimTier: 2,
  ...
  {
    id: 'crv-2021-42k', rearLegroomIn: 40.4, make: 'Honda', model: 'CR-V', trim: 'EX', trimTier: 1,
  ...
  {
    id: 'crv-2022-35k', rearLegroomIn: 40.4, make: 'Honda', model: 'CR-V', trim: 'Touring', trimTier: 3,
  ...
  // ── Honda CR-V Hybrid ────────────────────────────────────────────────
  {
    id: 'crv-hybrid-2023-30k', rearLegroomIn: 41, make: 'Honda', model: 'CR-V Hybrid', trim: 'Sport', trimTier: 1,
    year: 2023, condition: 'used', mileage: 30000, powertrain: 'hybrid',
  ...
  {
    id: 'crv-hybrid-2024-18k', rearLegroomIn: 41, make: 'Honda', model: 'CR-V Hybrid', trim: 'Sport-L', trimTier: 3,
  ...
  {
    id: 'civic-hb-hybrid-2025-12k', rearLegroomIn: 37.4, make: 'Honda', model: 'Civic Hatchback Hybrid', trim: 'Sport Hybrid', trimTier: 2,
  ...
  {
    id: 'civic-hb-hybrid-2026-new', rearLegroomIn: 37.4, make: 'Honda', model: 'Civic Hatchback Hybrid', trim: 'Sport Touring Hybrid', trimTier: 3,
    year: 2026, condition: 'new', mileage: 0, powertrain: 'hybrid',
  ...
  // ── Toyota RAV4 (gas) ────────────────────────────────────────────────
  {
    id: 'rav4-2019-70k', rearLegroomIn: 37.8, make: 'Toyota', model: 'RAV4', trim: 'LE', trimTier: 1,
    year: 2019, condition: 'used', mileage: 70000, powertrain: 'gas',
  ...
  {
    id: 'rav4-2020-58k', rearLegroomIn: 37.8, make: 'Toyota', model: 'RAV4', trim: 'XLE', trimTier: 2,
    year: 2020, condition: 'used', mileage: 58000, powertrain: 'gas',
  ...
  {
    id: 'rav4-2022-40k', rearLegroomIn: 37.8, make: 'Toyota', model: 'RAV4', trim: 'XLE', trimTier: 2,
    year: 2022, condition: 'used', mileage: 40000, powertrain: 'gas',
  ...
  // ── Toyota RAV4 Hybrid ───────────────────────────────────────────────
  {
    id: 'rav4-hybrid-2021-46k', rearLegroomIn: 37.8, make: 'Toyota', model: 'RAV4 Hybrid', trim: 'XLE', trimTier: 2,
  ...
  {
    id: 'rav4-hybrid-2023-28k', rearLegroomIn: 37.8, make: 'Toyota', model: 'RAV4 Hybrid', trim: 'XLE', trimTier: 2,
    year: 2023, condition: 'used', mileage: 28000, powertrain: 'hybrid',
